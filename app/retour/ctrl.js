    ...
    .controller('RetourCtrl', ['$scope', '$location', '$sce', function ($scope, $location, $sce) {
        ...
        $scope.changeData2 = function(id) {
            ...
            if (id == 'Coach Agile') {
                ...
                $scope.video_linkedin = "https://www.linkedin.com/cws/share?url=https://bit.ly/bit.ly/VMV-DevFront";
                $scope.video_facebook = "http://www.facebook.com/sharer.php?u=https://bit.ly/VMV-DevFront";
                $scope.blog_article = "http://blog.xebia.fr/2015/09/29/vis-ma-vie-episode-6-clement-daf-dun-jour";
